    ...
    <div className="rounded-2xl bg-card border border-border/50 overflow-hidden">
      ...
      <div className="p-4 grid grid-cols-2 gap-2.5">
        {actions.map((action) => (
          <button
            key={action.label}
            className="group flex flex-col items-center gap-2 p-4 rounded-xl bg-secondary/40 border border-border/40 hover:border-primary/30 hover:bg-primary/5 transition-all duration-300 hover:-translate-y-0.5 hover:shadow-sm active:scale-[0.98]"
          >
